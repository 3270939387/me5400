...
class MarkerDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "marker_uvs": torch.from_numpy(marker_uvs),  # torch.Tensor, [3]，marker的(u, v, s)
            "marker_visible": torch.tensor([marker_visible], dtype=torch.float32),  # torch.Tensor, [1]，marker是否可见
